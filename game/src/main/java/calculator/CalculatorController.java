...
public class CalculatorController extends Controller {
    ...
    @FXML
    private transient Button sin;
    @FXML
    private transient Button cos;
    @FXML
    private transient Button tan;
    @FXML
    private transient Button Exp;
    @FXML
    private transient Button exponent;
    @FXML
    private transient Button log;
    @FXML
    private transient Button ln;
