...
public class damnController extends controller {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        BlackPiece = new Image(getClass().getResource("/javafx/resources/damn/DamnPieceB.png").toString());
        WhitePiece = new Image(getClass().getResource("/javafx/resources/damn/DamnPieceW.png").toString());
