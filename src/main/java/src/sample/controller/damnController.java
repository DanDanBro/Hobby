...
public class damnController extends controller {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        BlackPiece = new Image(getClass().getResource("/sample/resources/damn/DamnPieceB.png").toString());
        WhitePiece = new Image(getClass().getResource("/sample/resources/damn/DamnPieceW.png").toString());
