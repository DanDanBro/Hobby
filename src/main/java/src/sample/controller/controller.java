...
public class controller implements Initializable {
    ...
    transient String dark = getClass().getResource("/sample/resources/dark.css").toExternalForm();
    transient String light = getClass().getResource("/sample/resources/light.css").toExternalForm();
    ...
    public void gotoSettings(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
                "/sample/resources/settings.fxml"));
            Parent root1 = fxmlLoader.load();
            changeScene(root1, fxmlLoader.getController());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void gotChess(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
                "/sample/resources/chessBoard.fxml"));
            Parent root1 = fxmlLoader.load();
            changeScene(root1, fxmlLoader.getController());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void gotoDamn(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
                "/sample/resources/damnBoard.fxml"));
            Parent root1 = fxmlLoader.load();
            changeScene(root1, fxmlLoader.getController());
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public void gotoCalc(ActionEvent actionEvent) {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(
                "/sample/resources/calculator.fxml"));
            Parent root1 = fxmlLoader.load();
            changeScene(root1, fxmlLoader.getController());
        } catch (IOException e) {
            e.printStackTrace();
